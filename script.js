...
// let api = 'https://dattebayo-api.onrender.com/clans'
// let api2 = 'https://dattebayo-api.onrender.com/characters'

// async function getData(){
//     let respuesta = await fetch(api);
//     let datos = await respuesta.json();
//     let clanes = datos.clans

//     for(let i=0; i<clanes.length; i ++) {
//         console.log(clanes[i].name)
// }
// }

// async function getCharacter(){
//     let respuesta = await fetch(api2);
//     let datos = await respuesta.json();
//     let character = datos.characters;
//     let uchiha = [];

//     for (let uchiha of character) {
//         console.log(uchiha)
//     }


//     // for(let i=0; i<character.length; i ++) {
//     //     console.log(character[i].personal.clan)
//     //     if (clan == uchiha) {
//     //     character()
//     //  }
//     //  else () {
...
async function getData(){
    ...
    try {
        ...
        for (let i = 0; i < personajes.length; i++){
            ...
            <div class="card">
            <img src="${personajes[i].image}" alt="Imagen del personaje" class="card-image">

            <div class="card-content">
                <h2 class="card-name">${personajes[i].name}</h2>
                <p class="card-species">${personajes[i].species}</p>
            </div>
            </div>       
